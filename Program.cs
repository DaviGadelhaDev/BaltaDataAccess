...
namespace BaltaDataAccess
{
    class Program
    {
       ...
       static void ExecuteProcedure(SqlConnection connection)
       {
            ...
            var pars = new { StudentId = "0ddc892e-c2a8-4c72-80f9-f05e632eab2d" };
            var rowsProcedure = connection.Execute(procedure, pars, commandType: System.Data.CommandType.StoredProcedure);
            Console.WriteLine($"{rowsProcedure} linhas afetadas");
       }
       ...
       static void ExecuteReadProcedure(SqlConnection connection)
       {
            ...
            //O query vai retornar uma lista de cursos
            var courses = connection.Query(procedure, pars, commandType: System.Data.CommandType.StoredProcedure);
            foreach(var item in courses)
            {
                //por ser do tipo dynamic, não temos acesso as propriedades dele
                Console.WriteLine(item.Id);
            }
       }
       //ExecuteScalar não retorna o int
       static void ExecuteScalar(SqlConnection connection)
       {
            ...
            Console.WriteLine($"O Id gerado foi: {id}");
        }
       ...
       static void OneToOne(SqlConnection connection)
       {
            ...
            var items = connection.Query<CareerItem, Course, CareerItem>(sql, (careerItem, course) => {
                ...
                //Sempre retorna o objeto pai
                return careerItem;
            }, splitOn: "Id"); /*Estamos usando o careerItem e o course e 
            o resultado dessa junção está dentro do careerItem*/
